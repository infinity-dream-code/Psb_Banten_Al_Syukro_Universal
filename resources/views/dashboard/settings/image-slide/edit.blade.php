...
<div class="max-w-2xl mx-auto bg-white shadow-lg rounded-xl p-8 mt-5">
    ...
    <form action="{{ route('setting-slider.update', $setting_slider->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="file" name="image" id="image"
                   class="block w-full text-sm text-gray-700 border border-gray-300 rounded-lg shadow-sm file:mr-4 file:py-2 file:px-4
