      ...
      <div class="max-w-md mx-auto w-full animate-slideInRight">
        ...
        <div class="mt-8 text-center">
          ...
          <div class="flex justify-center gap-4">
            <a href="#" class="w-12 h-12 flex items-center justify-center rounded-full bg-blue-600 text-white shadow-lg icon-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
              </svg>
            </a>
            
            <a href="#" class="w-12 h-12 flex items-center justify-center rounded-full bg-sky-400 text-white shadow-lg icon-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
