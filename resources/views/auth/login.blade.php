      ...
      <div class="max-w-md mx-auto w-full">
        ...
        <div class="mt-8 text-center">
          ...
          <div class="flex justify-center space-x-4">
            <!-- Home Icon (Blue) -->
            <a href="/" class="w-12 h-12 flex items-center justify-center rounded-full bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-110">
            ...
            <a href="/enroll" class="w-12 h-12 flex items-center justify-center rounded-full bg-sky-400 hover:bg-sky-500 text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-110">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
